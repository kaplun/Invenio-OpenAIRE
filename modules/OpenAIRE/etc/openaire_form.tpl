...
<tr class="body even" id="body_%(id)s">
    <td colspan="3">
        <div>
            ...
            <br />
            <textarea name="authors_%(id)s" id="authors_%(id)s" cols="70" rows="5" class="authors">%(authors)s</textarea>
        </div>
        <div>
        ...
        <div style="float: left; margin: 5px;">
            <fieldset>
                ...
                <div>
                    ...
                    <br />
                    <textarea name="abstract_%(id)s" id="abstract_%(id)s" cols="70" rows="5" class="abstract">%(abstract_value)s</textarea>
                </div>
            </fieldset>
        </div>
        <div style="float: left; margin: 5px;">
            <fieldset style="float: left;">
                ...
                <div id="original_language_container_%(id)s">
                    ...
                    <div>
                        ...
                        <br />
                        <textarea name="original_abstract_%(id)s" id="original_abstract_%(id)s" cols="70" rows="5" class="original_abstract">%(original_abstract_value)s</textarea>
                    </div>
                </div>
            </fieldset>
        </div>
...
$(document).ready(function(){
    ...
    $('#save_label_%(id)s').click(function(event){
        ajaxGateway('save');
        event.preventDefault();
        return 0;
    });
    $('#submit_label_%(id)s').click(function(event){
        ajaxGateway('submit');
        event.preventDefault();
        return 0;
    });
