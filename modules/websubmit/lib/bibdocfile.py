...
class BibDoc:
    ...
    def get_icon(self, subformat=CFG_WEBSUBMIT_ICON_SUBFORMAT):
        """
        @param subformat: by default the convention is that
            L{CFG_WEBSUBMIT_ICON_SUBFORMAT} is used as a subformat indicator to
        ...
        """
        for docfile in self.list_latest_files():
            if docfile.get_subformat() == subformat:
                return docfile
        return None

    def add_icon(self, filename, basename=None, format=None, subformat=CFG_WEBSUBMIT_ICON_SUBFORMAT):
        """
        ...
        @type format: string
        @param subformat: by default the convention is that
            CFG_WEBSUBMIT_ICON_SUBFORMAT is used as a subformat indicator to
            mean that a particular format is to be used as an icon.
            Specifiy a different subformat if you need to use a different
            convention.
        @type subformat: string
    ...
    def delete_icon(self, subformat=CFG_WEBSUBMIT_ICON_SUBFORMAT):
        """
        @param subformat: by default the convention is that
            L{CFG_WEBSUBMIT_ICON_SUBFORMAT} is used as a subformat indicator to
            mean that a particular format is to be used as an icon.
...
class BibDocFile:
    ...
    def is_icon(self, subformat=CFG_WEBSUBMIT_ICON_SUBFORMAT):
        """
        @param subformat: by default the convention is that
            L{CFG_WEBSUBMIT_ICON_SUBFORMAT} is used as a subformat indicator to
            mean that a particular format is to be used as an icon.
        ...
        @rtype: bool
        """
        return self.subformat == subformat
