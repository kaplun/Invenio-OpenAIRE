...
"""
Any2DjVu WebSubmit File Converter.
"""

import os
from invenio.config import CFG_PATH_ANY2DJVU
...
def converter(input_file, output_file, working_dir, resolution=400, ocr=True, input_format=5, **dummy):
    """
    ...
    @param working_dir [string] the temporary working_dir
