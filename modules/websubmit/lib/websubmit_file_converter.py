...
def can_spell_check(ln='en'):
    ...
    return bool(get_spell_checker(ln))
...
def tiff2pdf(input_file, output_file=None, pdfopt=True, pdfa=True, **args):
    """
...
def main_cli():
    ...
    if options.can_convert:
        if options.can_convert:
            ...
            if can_spell_check(options.ln):
                print "English spell checking supported"
            else:
                print "No spell checking support"
