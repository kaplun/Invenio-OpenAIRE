...
if sys.version_info[3] == 'pyjamas':
    ...
    class NullClass(object):
        def __init__(self, *args, **kwargs):
            pass
    CheckBox = ListBox = RadioButton = NullClass 
