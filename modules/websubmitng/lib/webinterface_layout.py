...
try:
    from invenio.websubmitng_webinterface import \
         WebInterfaceNGSubmit
except:
    register_exception(alert_admin=True, subject='EMERGENCY_NG')
    WebInterfaceNGSubmit = WebInterfaceDumbPages
