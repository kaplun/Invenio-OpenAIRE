...
class WebInterfaceNGSubmitPages(WebInterfaceDirectory):
        ...
        if component in self._doctypes:
            ...
            if not path:
                ...
                #Then, start the workflow corresponding to the action and the doctype.
                    ...
                    # Creation of 'submission' object can be made more efficient. Currently, everytime
                    # when the object is created, it consists of the entire corresponding parsed .ini
                    # file(with ALL its interfaces, workflows etc..) which is not required.
                    ...
                    if len(path) == 2 or wfe.getVar('status') in ['Completed', 'completed']:
                        ...
                        if len(path) == 3 and wfe.hasVar('interface_id'):
                            ...
                            # A form has been submitted.
                                ...
                                # Final dump(after the completion of the workflow.)
                                session.dump(wfe)
